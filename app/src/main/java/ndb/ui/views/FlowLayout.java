...
//	Zsolt Vasvari
//  https://groups.google.com/forum/?fromgroups=#!topic/android-developers/ksS0cBFmxxE
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
  {
    ...
    for (View child : getLayoutChildren())
    {
      ...
      if ((currentRow == null) || currentRow.isWouldExceedMax(childWidth))
      {
        ...
        //todo can count number of rows here i believe!!!!! actaully just need to call rows.size() at end
      }
